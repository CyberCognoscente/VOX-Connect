...
export default function ProfessionalBotPage() {
  ...
  const botTitle = "Professional Bot";
  const botDescription = "Work-focused help and productivity support";
  const assistantName = "vox-professional";
  const assistantId = "c53f9105-7c7f-4767-9e1a-04142d323b04";
  const publicKey = "03f690fe-ad3e-4344-935d-b869cabd59f9";
  const firstMessage = "hello i am vox professional how may i assist you today? ";
