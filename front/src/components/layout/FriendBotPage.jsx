...
export default function FriendBotPage() {
  ...
  const botTitle = "Friend Bot";
  const botDescription = "Companion-style friendly conversation";
  const assistantName = "vox-friend";
  const assistantId = "6552014a-be93-403f-9045-ab1c3016ea25";
  const publicKey = "03f690fe-ad3e-4344-935d-b869cabd59f9";
  const firstMessage = "hey i am vox friend how may i help you";
