...
export default function GeneralBotPage() {
  ...
  const botTitle = "General Bot";
  const botDescription = "Test multilingual voice input, instant replies, and assistant personalities built for real use cases.";
  const assistantName = "VOX";
  const assistantId = "290588d7-c7bf-4e5b-86cd-f0728192b43c";
  const publicKey = "03f690fe-ad3e-4344-935d-b869cabd59f9";
  const firstMessage = "Make conversations sound naturally intelligent.";
