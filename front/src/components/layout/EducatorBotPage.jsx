...
export default function EducatorBotPage() {
  ...
  const botTitle = "Educator Bot";
  const botDescription = "Learning support and concept explanations";
  const assistantName = "vox-tutor";
  const assistantId = "52edfe29-ba2a-4b72-8a8b-762799a9ce02";
  const publicKey = "03f690fe-ad3e-4344-935d-b869cabd59f9";
  const firstMessage = "hey i am vox tutor , what would you like to learn today?";
