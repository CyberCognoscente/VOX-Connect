...
const VoxLeftPanel = () => {
  ...
  return (
    <div className="w-[60%] h-screen bg-[#07031e] flex flex-col items-center justify-between p-8 text-center relative overflow-hidden">
      ...
      {/* Center Bot Illustration (Spacer/Main Content) */}
      <div className="relative mt-10 z-10 flex flex-col items-center">
        <div className="flex items-center justify-center mb-4">
          ...
          <img 
            ...
            // Image styled for size, positioned to the right of the text
            className="w-64 h-64 ml-8  bg-[#100b2f] " 
          />
        </div>
      </div>
      ...
      <div className="relative z-14 mb-5 mt-8"> 
